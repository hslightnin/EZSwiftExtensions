...
extension UIImageView {
    ...
    /// EZSwiftExtensions
    @available(swift, deprecated: 1.8, renamed: "image(url:)")
    ...
    /// EZSwiftExtensions
    @available(swift, deprecated: 1.8, renamed: "image(url:placeholder:)")
    ...
    /// EZSwiftExtensions
    @available(swift, deprecated: 1.8, renamed: "image(url:placeholderNamed:)")
