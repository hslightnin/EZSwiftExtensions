...
extension Double {
    ...
    @available(swift, deprecated: 1.8, renamed: "rounded(toPlaces:)")
    ...
    @available(swift, deprecated: 1.8, renamed: "ceil(toPlaces:)")
